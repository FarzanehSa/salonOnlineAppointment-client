...
import './DashboardAppointmentsReport.scss';
...
const DashboardAppointmentsReport = () => {
  ...
  const handleSearch = (event) => {
    ...
    axios.get(`${url}/api/reports/appointments`, {
      params: {...searchForm}
    })
    .then(res => {
...
export default DashboardAppointmentsReport;